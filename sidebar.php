<?php if(!defined('PLX_ROOT')) exit; ?>
	...
	<aside class="aside col sml-12 med-4" role="complementary">
		...
		<ul class="cat-list unstyled-list">
			<?php $plxShow->catList('','<li id="#cat_id"><a class="#cat_status" href="#cat_url" title="#cat_name">#cat_name</a> <span class="badge">#art_nb</span></li>'); ?>
		</ul>
		...
		<ul class="arch-list unstyled-list">
			<?php $plxShow->archList('<li id="#archives_id"><a class="#archives_status" href="#archives_url" title="#archives_name">#archives_name</a> <span class="badge">#archives_nbart</span></li>'); ?>
		</ul>
